...
<?php
	if (!empty($_GET['id'])) {
		...
		header("location: http://localhost/occko/webdong/html/quantri/tintuc/danhsachtintuc.php?page=1");
	}
	...
	if (!empty($_GET['idtype'])) {
		...
		deleteProduct($deletesql);
		header("location: http://localhost/occko/webdong/html/quantri/tintuc/danhmuctintuc.php?page=1");
	}
?>
</body>
</html>