<?php 
	...
	// var_dump($_POST['img']['name']);

	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		insertAlbum	($_POST);// xong add sp
	}
				...
				<div class="quantrimenu col-xs-12 col-sm-12 col-md-2 col-lg-2">
					...
					<div class="quantrimenuitem">
						<div class="row">
							...
							<div class="quantriheaderitem col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<a class="active" href="http://localhost/occko/webdong/html/quantri/album/dangalbum.php">Đăng album</a>
							</div>
							<div class="quantriheaderitem col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="quantrishowoff col-xs-12 col-sm-12 col-md-10 col-lg-10">
					<div class="row">
						<div class="quantriname col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<h1>
								<a href="http://localhost/occko/webdong/html/dangtintuc.php">
									Đăng album 
								</a>
							</h1>
						</div>
									...
									<div class="row">
										...
										<div class="inputform col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<div class="row">
												...
												<div class="col-md-10 col-sm-12 col-xs-12 col-lg-10"><textarea id="discription" type="text" name="name_discription" placeholder="This is some sample content."></textarea></div>
											</div>
										</div>
										<div class="inputform col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<div class="row">
							...
							<div class="item">
								...
								<div class="iteminput">
									<div class="quantripic">
										<h3>Chọn ảnh</h3>
										<form action="adgasd" method="POST" class="dropzone" id="dropzone">	
										</form>
										<form action="../function.php" class="dropzone">
										  <div class="fallback">
...
<!-- <script type="text/javascript">
	$('.quantriupdate button').on('click',function(){
		...
		console.log(x);
		if (x == 0) {
			window.location.assign("http://localhost/occko/webdong/html/quantri.php?move=1");
		}else if (x == 2) {
			window.location.assign("http://localhost/occko/webdong/html/danhsach.php");
		}
	})
</script> -->
	<script>
