				...
				<div class="quantrimenu col-xs-12 col-sm-12 col-md-2 col-lg-2">
					<div class="quantrimenuitem">
						<div class="row">
							...
							<div class="quantriheaderitem col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<a class="active" href="http://localhost/occko/webdong/html/quantri/sanpham/danhsach.php">Quản trị danh sách sản phẩm</a>
							</div>
							<div class="quantriheaderitem col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<div class="iteminput">
									<div class="row">
										...
										<div class="inputform col-xs-12 col-sm-12 col-md-6 col-lg-6">
											<div class="row">
												<label class="col-xs-12 col-sm-12 col-md-4 col-lg-4">Tên danh mục sản phẩm <span>*</span></label>
												<div class="col-md-8 col-sm-12 col-xs-12 col-lg-8"><input type="text" name="name" placeholder="ABCD" value="<?php echo $product_type_item['name'] ?>"></div>
											</div>
										</div>
										<div class="inputform col-xs-12 col-sm-12 col-md-6 col-lg-6">
											<div class="row">
												<label class="col-xs-12 col-sm-12 col-md-4 col-lg-4">Tên gọi rút gọn <span>*</span></label>
												<div class="col-md-8 col-sm-12 col-xs-12 col-lg-8"><input type="text" name="shortened_name" placeholder="abcd1234" value="<?php echo $product_type_item['shortened_name'] ?>"></div>
											</div>
										</div>
											...
											<div class="row">
												...
												<div class="quantritinhtrang col-xs-12 col-sm-12 col-md-10 col-lg-10">
													<select id="search_type" name="parent_id">
														...
														<?php 
															// print_r($list_type_op);
															foreach ($list_type_op as $k1 => $v1) {
																if ($v1['id'] == $_GET['id']) {
																	$r = $v1['parent_id'];
																}
															}
															echo $r;
															//thiết lâp dao diện
															function showCategories($list_type_op, $parent_id = 0, $char = ''){
																foreach ($list_type_op as $z => $x) {
																	if ($x['parent_id'] == $parent_id){
														?>
																		<option id="op<?php echo $x['id'] ?>" value="<?php echo $x['id'] ?>"><?php echo $char . $x['name'] ?></option>
														<?php
																		// unset($list_type_op[$z]);
																		showCategories($list_type_op, $x['id'], $char.'---');
																	}				
																}
															}
															// hiển thị dao diện
															showCategories($list_type_op);
														?>
													</select>
										...
										<div class="inputform col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<div class="row">
												...
												<div class="col-md-10 col-sm-12 col-xs-12 col-lg-10"><input type="text" name="discription" placeholder="abcd" value="<?php echo $product_type_item['discription'] ?>"></div>
											</div>
										</div>
										<div class="inputform col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<div class="row">
												...
												<div class="quantritinhtrang col-xs-12 col-sm-12 col-md-10 col-lg-10">
													<span class="">
														<div class="quantricheckbox">
															<div class="checkbox col-xs-12 col-sm-12 col-md-3 col-lg-3"><label class="checkbox-inline"><input type="radio" name="check_list[]" value="on">Hiển thị</label></div>
															<div class="checkbox col-xs-12 col-sm-12 col-md-3 col-lg-3"><label class="checkbox-inline"><input type="radio" name="check_list[]" value="commingon">Đang hiển thị</label></div>
															<div class="checkbox col-xs-12 col-sm-12 col-md-3 col-lg-3"><label class="checkbox-inline"><input type="radio" name="check_list[]" value="off">Không hiển thị</label></div>
														</div>
													</span>
												</div>
											</div>
