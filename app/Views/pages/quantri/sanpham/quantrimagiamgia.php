				...
				<div class="quantrimenu col-xs-12 col-sm-12 col-md-2 col-lg-2">
					<div class="quantrimenuitem">
						<div class="row">
							...
							<div class="quantriheaderitem col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<a class="active" href="http://localhost:81/occko/webdong/html/quantri/sanpham/quantrimagiamgia.php">Quản trị thêm mã giảm giá</a>
							</div>
							<div class="quantriheaderitem col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="row">
						...
						<div class="quantriitem col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="item">
								<div class="itemname">
									<strong><i class="fa fa-list-alt" aria-hidden="true"></i>THÔNG TIN CƠ BẢN MÃ GIẢM GIÁ</strong>
								...
								<div class="iteminput">
									<div class="row">
										<div class="inputform col-xs-12 col-sm-12 col-md-6 col-lg-6">
											<div class="row">
												<label class="col-xs-12 col-sm-12 col-md-4 col-lg-4">Mã giảm giá <span>*</span></label>
												<div class="col-md-8 col-sm-12 col-xs-12 col-lg-8"><input type="text" name="code" placeholder="abcd1234"></div>
											</div>
										</div>
										<div class="inputform col-xs-12 col-sm-12 col-md-6 col-lg-6">
											<div class="row">
												<label class="col-xs-12 col-sm-12 col-md-4 col-lg-4">Số lần áp dụng <span>*</span></label>
										...
										<div class="inputform col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<div class="row">
												<label class="col-xs-12 col-sm-12 col-md-2 col-lg-2">Điều kiện áp dụng <span>*</span></label>
												<div class="col-md-10 col-sm-12 col-xs-12 col-lg-10"><input type="num" name="min" placeholder="1000000"></div>
											</div>
										</div>
										<div class="inputform col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<div class="row">
												<label class="col-xs-12 col-sm-12 col-md-2 col-lg-2">Giá trị mã <span>*</span></label>
												<div class="col-md-10 col-sm-12 col-xs-12 col-lg-10"><input type="num" name="value" placeholder="100000"></div>
											</div>
										</div>
										<div class="inputform col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<div class="row">
												<label class="col-xs-12 col-sm-12 col-md-2 col-lg-2">Hình thức <span>*</span></label>
												<div class="quantritinhtrang col-xs-12 col-sm-12 col-md-10 col-lg-10">
													<span class="">
														<div class="quantricheckbox">
															<div class="radio col-xs-12 col-sm-12 col-md-6 col-lg-6"><label class="checkbox-inline"><input type="radio" name="type" value="1">Giảm trực tiếp</label></div>
															<div class="radio col-xs-12 col-sm-12 col-md-6 col-lg-6"><label class="checkbox-inline"><input type="radio" name="type" value="0">Giảm theo phần trăm</label></div>
														</div>
													</span>
												</div>
											</div>
										...
										<div class="inputform col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<div class="row">
												...
												<div class="quantritinhtrang col-xs-12 col-sm-12 col-md-10 col-lg-10">
													<span class="">
														<div class="quantricheckbox">
															<div class="radio col-xs-12 col-sm-12 col-md-6 col-lg-6"><label class="checkbox-inline"><input type="radio" name="status" value="1">Hiển thị</label></div>
															<div class="radio col-xs-12 col-sm-12 col-md-6 col-lg-6"><label class="checkbox-inline"><input type="radio" name="status" value="0">Ẩn</label></div>
														</div>
													</span>
												</div>
											</div>
						...
						<div class="quantriupdate col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="quantridelete">
								...
								<button>
									<input type="submit" name="submit" value="Lưu và đồng bộ">
								</button>
							</div>
						</div>
					</div>
